...
<head>
    ...
    <meta name="description" content="Challenge student-coded AI opponents in real-time Battleship battles. Test your strategy against competitive algorithms.">
    <meta name="keywords" content="battleship, play online, AI opponent, strategy game, multiplayer battleship">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{.ServerURL}}/play">
    <meta property="og:title" content="Play Battleship - Challenge AI Opponents">
    <meta property="og:description" content="Challenge student-coded AI opponents in real-time Battleship battles. Test your strategy against competitive algorithms.">
    <meta property="og:image" content="https://hc-cdn.hel1.your-objectstorage.com/s/v3/d5baa2ef6d8e9f89_10379.png">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{.ServerURL}}/play">
    <meta property="twitter:title" content="Play Battleship - Challenge AI Opponents">
    <meta property="twitter:description" content="Challenge student-coded AI opponents in real-time Battleship battles. Test your strategy against competitive algorithms.">
    ...
    <link rel="canonical" href="{{.ServerURL}}/play">
    <style>
        * {
            margin: 0;
            padding: 0;
